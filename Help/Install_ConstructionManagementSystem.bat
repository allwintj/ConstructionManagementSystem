...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "ConstructionManagementSystem" /productName "ConstructionManagementSystem" > NUL
...
COPY /Y "ConstructionManagementSystem.msha" HelpContentSetup.msha
